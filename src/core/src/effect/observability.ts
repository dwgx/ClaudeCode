...
import { ensureProcessMetadata } from "../util/claudecode-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "claudecode.client": Flag.CLAUDECODE_CLIENT,
      "claudecode.process_role": processMetadata.processRole,
      "claudecode.run_id": processMetadata.runID,
