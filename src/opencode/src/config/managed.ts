...
const MANAGED_PLIST_DOMAIN = "ai.claudecode.managed"

// Keys injected by macOS/MDM into the managed plist that are not ClaudeCode config
...
function systemManagedConfigDir(): string {
  switch (process.platform) {
    ...
    default:
      return "/etc/claudecode"
  }
}

export function managedConfigDir() {
  return process.env.CLAUDECODE_TEST_MANAGED_CONFIG_DIR || systemManagedConfigDir()
}
