...
export const GlobalRoutes = lazy(() =>
  new Hono()
    .get(
      ...
      describeRoute({
        summary: "Get health",
        description: "Get health information about the ClaudeCode server.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Subscribe to global events from the ClaudeCode system using server-sent events.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current global ClaudeCode configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update global ClaudeCode configuration settings and preferences.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose all ClaudeCode instances, releasing all resources.",
    ...
    .post(
      "/upgrade",
      describeRoute({
        summary: "Upgrade claudecode",
        description: "Upgrade claudecode to the specified version or latest if not specified.",
