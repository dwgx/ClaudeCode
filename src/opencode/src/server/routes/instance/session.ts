  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all ClaudeCode sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific ClaudeCode session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new ClaudeCode session for interacting with AI assistants and managing conversations.",
