...
import { ClaudeCodeHttpApi } from "./api"
...
const LegacyComponentDescriptions = {
  LogLevel: "Log level",
  ServerConfig: "Server configuration for claudecode serve and web commands",
...
function fixSelfReferencingComponents(spec: OpenApiSpec) {
  ...
  const raw = OpenApi.fromApi(ClaudeCodeHttpApi) as unknown as OpenApiSpec
...
export const PublicApi = ClaudeCodeHttpApi.annotateMerge(
  OpenApi.annotations({
    title: "claudecode",
    version: "1.0.0",
    description: "claudecode api",
