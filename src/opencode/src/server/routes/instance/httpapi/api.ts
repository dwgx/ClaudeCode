...
export const RootHttpApi = HttpApi.make("claudecode-root").addHttpApi(ControlApi).addHttpApi(GlobalApi)

export const InstanceHttpApi = HttpApi.make("claudecode-instance")
...
export const ClaudeCodeHttpApi = HttpApi.make("claudecode")
