import type * as SDK from "@dwgx/claudecode-sdk/v2"
...
const disabled = process.env["CLAUDECODE_DISABLE_SHARE"] === "true" || process.env["CLAUDECODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@claudecode/ShareNext") {}
