...
import { sanitizedProcessEnv } from "@dwgx/claudecode-core/util/claudecode-process"
...
export class Service extends Context.Service<Service, Interface>()("@claudecode/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".claudecode")) continue
