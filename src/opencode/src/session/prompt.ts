...
import * as EffectLogger from "@dwgx/claudecode-core/effect/logger"
...
export class Service extends Context.Service<Service, Interface>()("@claudecode/SessionPrompt") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const insertReminders = Effect.fn("SessionPrompt.insertReminders")(function* (input: {
      ...
      if (!Flag.CLAUDECODE_EXPERIMENTAL_PLAN_MODE) {
