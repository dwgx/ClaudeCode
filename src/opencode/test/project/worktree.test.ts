      ...
      provideTmpdirInstance(
        () =>
          Effect.gen(function* () {
            ...
            expect(info.branch).toBe(`claudecode/${info.name}`)
      ...
      provideTmpdirInstance(
        () =>
          Effect.gen(function* () {
            ...
            expect(info.branch).toBe("claudecode/my-feature")
          }),
        { git: true },
      ),
    )
      ...
      provideTmpdirInstance(
        () =>
          Effect.gen(function* () {
            ...
            expect(info.name).toBeDefined()
            expect(info.branch).toStartWith("claudecode/")
      ...
      provideTmpdirInstance(
        () =>
          Effect.gen(function* () {
            ...
            expect(info.branch).toBe("claudecode/test-workspace")
