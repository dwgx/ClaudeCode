...
const originalHttpApi = Flag.CLAUDECODE_EXPERIMENTAL_HTTPAPI
const originalWorkspaces = Flag.CLAUDECODE_EXPERIMENTAL_WORKSPACES

function app(httpapi = true) {
  Flag.CLAUDECODE_EXPERIMENTAL_HTTPAPI = httpapi
...
afterEach(async () => {
  Flag.CLAUDECODE_EXPERIMENTAL_HTTPAPI = originalHttpApi
