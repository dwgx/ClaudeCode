...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/claudecode.git")).toEqual({ owner: "sst", repo: "claudecode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/claudecode")).toEqual({ owner: "sst", repo: "claudecode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/claudecode.git")).toEqual({ owner: "sst", repo: "claudecode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/claudecode")).toEqual({ owner: "sst", repo: "claudecode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/claudecode.git")).toEqual({ owner: "sst", repo: "claudecode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/claudecode")).toEqual({ owner: "sst", repo: "claudecode" })
})
