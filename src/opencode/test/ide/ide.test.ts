...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CLAUDECODE_CALLER", () => {
    process.env["CLAUDECODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CLAUDECODE_CALLER", () => {
    process.env["CLAUDECODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CLAUDECODE_CALLER", () => {
    process.env["CLAUDECODE_CALLER"] = "unknown"
