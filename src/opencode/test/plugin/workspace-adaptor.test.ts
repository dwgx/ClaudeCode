...
const { Flag } = await import("@dwgx/claudecode-core/flag/flag")
const { Plugin } = await import("../../src/plugin/index")
const { Workspace } = await import("../../src/control-plane/workspace")
const { Instance } = await import("../../src/project/instance")

const experimental = Flag.CLAUDECODE_EXPERIMENTAL_WORKSPACES

Flag.CLAUDECODE_EXPERIMENTAL_WORKSPACES = true
...
afterAll(() => {
  ...
  Flag.CLAUDECODE_EXPERIMENTAL_WORKSPACES = experimental
})
