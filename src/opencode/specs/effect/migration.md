...
Practical reference for new and migrated Effect code in `packages/claudecode`.
...
export class Service extends Context.Service<Service, Interface>()("@claudecode/Foo") {}
