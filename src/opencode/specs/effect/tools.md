...
Practical reference for the current tool-migration state in `packages/claudecode`.
...
Tool tests should use the existing Effect helpers in `packages/claudecode/test/lib/effect.ts`:
