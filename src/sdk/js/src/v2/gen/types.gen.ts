...
/**
 * Server configuration for claudecode serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: claudecode.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://github.com/dwgx/ClaudeCode/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://github.com/dwgx/ClaudeCode/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
